...
%left   MULTIPLY
%left POWER
%type <nPtr> MATH_CALC Casting UniaryEXP MATH_EXPR DataVAL LOG_EXPR Expr
...
Var_Dec:CONST Data_Type IDENTIFIER Assign SEMI_COLON
        |Data_Type Assign SEMI_COLON
        |Data_Type IDENTIFIER SEMI_COLON;
